...
| [#88570](https://github.com/openclaw/openclaw/issues/88570) | Product-wide | CLI, runtime errors, channel notices, UI pages, authoring automation, and coverage reporting remain incomplete. | Umbrella coverage | All projected owner entries, including the `G45` scoped gate, `G46` trusted refresh, and `G47` new-surface disposition gate; completion still uses landed owner evidence, not the count |
