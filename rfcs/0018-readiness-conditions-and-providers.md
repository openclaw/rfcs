...
It is one upstream PR at exact head `64bba7771598`. Focused readiness, live
...
stacked at exact readiness head `64bba7771598` and exact implementation head
`25026844df5a`. It adds selectable core-owner criteria,
