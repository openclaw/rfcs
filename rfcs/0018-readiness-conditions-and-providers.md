...
It is one upstream PR with seventeen ordered commits at exact head `e5834f2a18e7`.
...
stacked at exact readiness head `e5834f2a18e7` and exact implementation head
`24970fe0ee47`. It adds selectable core-owner criteria,
