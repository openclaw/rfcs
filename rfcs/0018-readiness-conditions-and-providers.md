...
It is one upstream PR with fourteen ordered commits at exact head `f1af3de0a9b1`.
...
stacked at exact readiness head `f1af3de0a9b1` and exact implementation head
`785a11b05e9c`. It adds selectable activation,
