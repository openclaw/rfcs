...
It is one upstream draft PR with four ordered commits, exact-head tests, and
package-installed Docker proof. Reviewers should use that PR for the proposed
landing shape and current validation state.
